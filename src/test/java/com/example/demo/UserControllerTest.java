...
public class UserControllerTest {
    ...
    @Test
    public void testFindUserById_thenUserIsReturned() {
        long id = 1L;
    ...
    @Test
    public void testFindUserByUsername_thenUserIsReturned() {
        User mockUser = new User();
        mockUser.setUsername(TEST_USERNAME);
    ...
    @Test
    public void testFindUserByNonExistentUsername_thenNotFoundErrorIsReturned() {
        User mockUser = new User();
        mockUser.setUsername(TEST_USERNAME);
        when(userRepository.findByUsername(TEST_USERNAME)).thenReturn(mockUser);
    ...
    @Test
    public void testCreationRequestHasValidCredentials_thenUserIsCreated() {
    ...
    @Test
    public void testCreationRequestHasInvalidPassword_thenUserIsNotCreated() {
        CreateUserRequest createUserRequest = new CreateUserRequest();
        createUserRequest.setUsername(TEST_USERNAME);
        createUserRequest.setPassword(TEST_PASSWORD);
    ...
    @Test
    public void testCreationRequestIsWithoutMatchingPassword_thenUserIsNotCreated() {
        CreateUserRequest createUserRequest = new CreateUserRequest();
        createUserRequest.setUsername(TEST_USERNAME);
